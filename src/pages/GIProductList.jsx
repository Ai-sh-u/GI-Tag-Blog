...
const products = [
  ...
  },
  {
    ...
    summary: 'GI-tagged vegetable from Udupi, Karnataka. GT-tags ensure farm-to-table traceability and freshness tracking.',
  ...
  },
  {
    ...
    summary: 'From Tamil Nadu’s firecracker hub. GT-tags used for safe inventory handling and sales tracking.',
  ...
  },
  {
    ...
    summary: 'Renowned for high curcumin content. GT-tags help track farm origin, export, and quality certification.',
  ...
  },
  {
    ...
    summary: 'Knitwear products from Tamil Nadu’s textile hub. GT-tags assist in logistics, batch tracing, and export compliance.',
    image: 'https://www.adthyaexports.in/img/infrastructure/packing.jpg'
  },
  {
    id: 7,
    title: 'Salem Steel Sheets',
    summary: 'Steel products used in construction and appliances. GT-tags enable tracking, inventory, and shipment history.',
  ...
  },
  {
    ...
    summary: 'Industrial motors from Karnataka. GT-tags provide part identification, warranty tracking, and asset monitoring.',
  ...
  },
  {
    ...
    summary: 'Traditional GI-tagged string instrument. GT-tags prove craftsmanship and track authenticity in cultural exports.',
